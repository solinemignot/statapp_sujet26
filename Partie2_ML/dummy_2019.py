...
# Dummy pour les variables spécifiées, en excluant les valeurs égales à -1
columns_to_dummy = ['lum', 'agg', 'dep', 'int', 'atm', 'catr', 'circ', 'nbv', 'prof', 'plan', 'surf', 'situ', 'infra', 'vma']
...
columns_to_drop = ['Num_Acc', 'an', 'jour', 'hrmn', 'col', 'com', 'adr', 'gps', 'lat', 'long', 'voie', 'v1', 'v2', 'pr', 'pr1', 'vosp', 'lartpc', 'larrout', 'date']
