...
plt.title('Matrice de corrélation pour 2019 avec dummies seulement')
plt.savefig(path+'Partie2_ML/'+'confusion_matrix_dummies_only.png')  # Enregistrer la matrice de confusion en tant qu'image
plt.show()
